 ...
 */
final class Version20181224170022 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE admin_messages (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(40) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, website VARCHAR(50) DEFAULT NULL, subject VARCHAR(255) DEFAULT NULL, message VARCHAR(255) DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, status VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
