 ...
 */
final class Version20181226135904 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(180) NOT NULL, CHANGE roles roles VARCHAR(50) DEFAULT NULL, CHANGE name name VARCHAR(45) DEFAULT NULL, CHANGE status status VARCHAR(230) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE isimsoyisim isimsoyisim VARCHAR(230) NOT NULL, CHANGE telefon telefon VARCHAR(230) NOT NULL, CHANGE types types VARCHAR(230) NOT NULL, CHANGE city city VARCHAR(230) DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE users DROP status, CHANGE password password VARCHAR(40) NOT NULL, CHANGE telefon telefon VARCHAR(40) NOT NULL, CHANGE roles roles VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(50) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE roles roles LONGTEXT DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE password password VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE name name VARCHAR(39) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE status status VARCHAR(30) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE isimsoyisim isimsoyisim VARCHAR(250) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE types types VARCHAR(200) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE telefon telefon VARCHAR(250) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE city city VARCHAR(100) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE address address VARCHAR(150) DEFAULT NULL COLLATE latin1_swedish_ci');
        $this->addSql('ALTER TABLE users ADD status VARCHAR(40) NOT NULL COLLATE latin1_swedish_ci, CHANGE password password VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE roles roles LONGTEXT DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE telefon telefon LONGTEXT DEFAULT NULL COLLATE latin1_swedish_ci');
    }
}
