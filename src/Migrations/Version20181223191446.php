 ...
 */
final class Version20181223191446 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin_settings DROP status, CHANGE s_id s_id INT NOT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE fax fax VARCHAR(255) DEFAULT NULL, CHANGE tel tel VARCHAR(150) DEFAULT NULL, CHANGE email email VARCHAR(150) DEFAULT NULL, CHANGE smtpserver smtpserver VARCHAR(150) DEFAULT NULL, CHANGE smtpmail smtpmail VARCHAR(150) DEFAULT NULL, CHANGE smtppasw smtppasw VARCHAR(20) DEFAULT NULL, CHANGE aboutus aboutus VARCHAR(255) DEFAULT NULL');
